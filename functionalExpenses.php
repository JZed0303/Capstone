...
<html lang="en">
   ...
   <style>
      ...
      th, td {
      border: 0.5px solid rgb(171, 181, 243);
      padding: 8px;
      }
      th {
      text-align: left;
   ...
   <body>
         ...
         <div class="content">
                     ...
                     <div class="row g-3 p-md-3 p-lg-3 p-2">
                        <div class="col-12 col-md-6 col-lg-12">
                           <form method="POST" class="d-flex flex-wrap justify-content-between align-items-center">
                              ...
                              <div class="d-flex flex-wrap justify-content-between align-items-center mb-2">
                                 <div class="form-group me-md-3 mb-2">
            ...
            <div class="container-fluid wrapper px-3">
               <div class="row g-2 mx-1 mb-3">
                  <div class="wrapper col-12 rounded-3 px-md-4">
                           ...
                           <div class=" bg-white">
                            ...
                            <div class="header-space"><img class ="p-0 m-0" src="assets/img/header.png" alt=""></div>
                              ...
                              <div class="table-print table-responsive" >
                                 <table id="expensesTable" class="lg-shadow border-none borderless">
                                    <thead>
                                       <hr>
                                       <div class="text-center p-3" style="border-top-left-radius: 5px;border-top-right-radius: 5px;background: white;color: #34363a;font-weight: bold;">
                                          ROTARACT CLUB OF CARMONA <br>
                                          STATEMENT OF FUNCTIONAL EXPENSES
                                       ...
                                       <tr>
                                          <th colspan="2" style="
                                             background: #0a346a!important;color:white
                                             ">Account No.</th>
                                          <th style="
                                             background: #0a346a!important;color:white
                                             " >Expense Category
                                          <th style="
                                             background: #0a346a!important;color:white
                                             " style="width: 1%;">Total Expense</th>
                                          </th >
                                       </tr>
                                    </thead>
                                    <tbody>
                                       <?php 
                                          ...
                                          echo '<td class="'; 
                                          // Check if "Expense Child Number" is empty
                                          if (empty($row["Expense Child Number"])) {
                                              echo 'bg-secondary'; // Add bg-secondary class if it's empty
                                          }
                                          echo '" id="amount" style="width: 6%; text-align: right; color: black;">' . ($row["Expense Child Number"] ? $row["Expense Child Number"] : 'N/A') . '</td>';
      ...
      <script>
         $(document).ready(function() {
                      ...
                      var tdnone = document.getElementById('amount');
                      console.log(tdnone);
                  }); 
